...
public class TripleShooterSubsystem extends SubsystemBase {
  ...
  public Command startMotorsCommand(double rpm) {
    return new SequentialCommandGroup(
        Commands.runOnce(() -> setRPM(rpm, leftMotor)),
        new WaitCommand(250),
        Commands.runOnce(() -> setRPM(rpm, middleMotor)),
        new WaitCommand(250),
        Commands.runOnce(() -> setRPM(rpm, rightMotor)));
  }
  ...
  public void setDistanceToTarget(double dist) {
